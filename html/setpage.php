...
print("
    ...
    <div class='setPageBackground'>
        <div class='setPageImage'>
            <img src='$prefix/SL/$set.jpg' id='setPic' alt='Setpicture'>
        </div> 
    <div id='setInfo'>
    <h4> Set: $setname</h4><br><p> ID: $set</p><br><p> Released $year</p><br><p> Category: $catName</p><br><p> Amount of $partname pieces needed: $quantity</p>
    </div>
    </div>
    </div>
    ");
